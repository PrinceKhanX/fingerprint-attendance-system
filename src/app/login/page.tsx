            ...
            <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
              ...
              >
                <span className="flex items-center gap-2">
                  <svg 
                    className={`animate-spin h-4 w-4 sm:h-5 sm:w-5 ${loading ? 'block' : 'hidden'}`} 
                    viewBox="0 0 24 24"
                    aria-hidden="true"
                  >
                  ...
                  <span className={loading ? '' : 'hidden'}>Logging in...</span>
                  <span className={loading ? 'hidden' : 'flex items-center justify-center gap-2'}>
                    Login
